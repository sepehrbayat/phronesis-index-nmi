...
\begin{itemize}
    ...
    \item Grid-world Bellman: $\Phi_{\text{crit}} = 0.5$
...
\begin{center}
\url{https://github.com/sepehrbayat/phronesis-index-nmi}
\end{center}
...
\begin{itemize}
    ...
    \item Example scenarios (Logic Maze, Grid-world Bellman, Multi-Robot)
    \item Docker container for full reproducibility
\end{itemize}
