...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figure1_timeseries.png}
\caption{Time series of the Phronesis Index $\Phi$ in the Logic Maze experiment. $\Phi$ drops sharply at $t=50$ when a contradiction is injected into the constraint network, and recovers when the anomaly is removed. Shaded region shows $\pm 1$ standard deviation over 10 independent runs. The continuous signal enables early warning before complete system failure.}
