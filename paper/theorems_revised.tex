...
The STPGC algorithm (Algorithm~\ref{alg:stpgc}) computes the Phronesis Index $\Phi$ in:
\begin{equation}
...
\begin{itemize}
    ...
    \item If $\sigma \geq \delta/4$, use noise filtering (Appendix~\ref{app:robustness}) or increase $\epsilon$ adaptively.
\end{itemize}
\end{remark}
